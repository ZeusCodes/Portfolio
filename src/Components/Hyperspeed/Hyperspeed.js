  ...
  useEffect(() => {
    ...
    class App {
      ...
      init() {
        ...
        const button = document.querySelector("#contact-submit"); // replace with your actual button's ID or selector
        button.addEventListener("mouseenter", this.onMouseDown);
        button.addEventListener("mouseleave", this.onMouseUp);
